...
class TriggerPusher(object):
    ...
    """
    def __init__(self, running_fpath, file_finder, root_dir_suffix="/data/triggers_truncated_localizers/",
                 export_dir_suffix="/data/triggers_truncated_localizers/",
                 trigger_dir_suffix="/data/toolbox_staging/triggers_trucated_localizers/",
                 truncate_triggers=[]):
